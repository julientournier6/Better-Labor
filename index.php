...
?>
    ...
    <div class = "conséquences">  
        <div class = "sueur_déshydratation">
            <div class = "texte_sueur">
                <p1 class="text">
            ...
            <div class = "image_sueur">
                <img src = "images/Ouvrier en sueur.png" alt = "Ouvrier en sueur">
            </div>
        </div>
            <div class = "bruit_sonore">
                <div class = "image_bruit">
                    <img src = "images/Pollution sonore.jpg" alt = "Pollution sonore">
                </div>
                <div class = "texte_bruit">
                    <p1 class="text">
